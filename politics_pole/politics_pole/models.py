...
class Decree(models.Model):
    id = models.IntegerField(primary_key=True)  # AutoField?
    decree_number = models.IntegerField(unique=True, blank=True, null=True)
...
class Vote(models.Model):
    ...
    decree = models.ForeignKey(Decree, primary_key=True, related_name='decree')
    vote_value = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'vote'
        unique_together = (('deputy_id', 'decree_id'),)
